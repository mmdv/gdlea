    ...
    <table bgcolor="#f0ffff" border="1" cellspacing="0" cellpadding="0" width="80%">
        ...
        <tr>
            ...
            <td>
                ...
                <img src="testCaptcha.php" alt="" id="verifyImage"><a onclick="document.getElementById('verifyImage').src='testCaptcha.php?r='+Math.random()" href="javascript:void(0)">看不清,换一张</a>
            </td>
        </tr>
        <tr>
